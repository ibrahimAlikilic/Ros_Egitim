...
def generate_launch_description():
    ...
    urdf_path = os.path.join(get_package_share_path('my_robot_description'),'src', 'urdf', 'main.xacro')
    rviz_config_path = os.path.join(get_package_share_path('my_robot_description/src'),'src', 'rviz', 'urdf_config.rviz')
